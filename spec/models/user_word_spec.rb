...
RSpec.describe UserWord, type: :model do
  ...
  describe "#fundamental_in_progress?" do
    it "returns true, i.e. Fundamental game is in progress for UW" do
      user = User.create(
        username: "fizzBuzzzzed",
        password: "password",
        password_confirmation: "password",
      ...
      expect(user_word.fundamental_in_progress?).to eq(true)
    end

    it "returns false, i.e. Fund game is not in progress for UW -> ns" do
      user = User.create(
        username: "fizzBuzzzzed",
        password: "password",
        password_confirmation: "password",
      ...
      expect(user_word.fundamental_in_progress?).to eq(false)
    end

    it "returns false, i.e. Fund game is not in progress for UW -> completed" do
      user = User.create(
        username: "fizzBuzzzzed",
        password: "password",
        password_confirmation: "password",
