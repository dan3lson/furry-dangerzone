class Word < ActiveRecord::Base
  ...
  def self.third_grade_word_names
    third_grade_words = [
    	"ability",
    	"absorb",
    	"accuse",
  ...
  def self.third_grade
    ids = [6487, 6515, 6527, 6838, 6539, 6551, 6555, 6571, 6841, 6849, 6577,
      6584, 6591, 6860, 6594, 6862, 6865, 6871, 6876, 6614, 6881, 6883, 6890,
      6622, 6624, 6897, 6899, 6654, 6659, 6900, 6663, 6667, 6671, 6680, 6683,
      6688, 6907, 6690, 6913, 6693, 6923, 6930, 6699, 6936, 6940, 6705, 6944,
      6716, 6953, 6956, 6719, 6739, 6745, 6755, 6757, 6957, 6961, 6967, 6974,
      6794, 6975, 6815, 6989, 6995, 6833, 7001, 7012, 7019, 7021, 7023, 7029,
      7040, 7045, 7050, 7055]
    Word.find(ids)
  end
  ...
  def self.fifth_grade
    ids = [
      6096, 6099, 6101, 6104, 6107, 3912, 6109, 6114, 6116, 6125, 6126, 6130,
      6131, 6134, 6136, 6145, 6155, 6159, 6165, 5563, 6166, 6169, 6171, 6177,
      6188, 6192, 6197, 6203, 6211, 6213, 6215, 6216, 6220, 6223, 6226, 6227,
      6231, 6233, 6234, 6237, 6238, 6244, 6247, 6250, 6253, 6265, 6267, 6269,
      6270, 6273, 6285, 6286, 6288, 6290, 6293, 6295, 6302, 6305, 6307, 6308,
      6319, 6321, 6326, 6329, 6333, 6334, 6336, 6338, 6345, 6349, 6351, 6353,
      6363, 6365, 6369
    ]
    Word.find(ids)
  end
