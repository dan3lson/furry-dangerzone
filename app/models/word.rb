class Word < ActiveRecord::Base
  ...
  def self.seventh_grade
    ids = [3243, 3248, 3253, 3262, 3268, 3272, 3309, 3315, 3333, 3339, 3349,
      3369, 3372, 3382, 3384, 3387, 3255, 3266, 3270, 3275, 3287, 3299, 3308,
      3312, 3318, 3325, 3362, 3371, 3383, 3389, 3691, 3693, 3392, 3396, 3403,
      3414, 3415, 3424, 3434, 3692, 3473, 3481, 3489, 3492, 3496, 3502, 3519,
      3522, 3566, 3597, 3620, 3625, 3635, 3641, 3654, 3667, 3670, 3477, 3485,
      3494, 3504, 3527, 3537, 3552, 3556, 3565, 3574, 3592, 3601, 3605, 3619,
      3621, 3629, 3634, 3644]
    Word.find(ids)
  end
end
